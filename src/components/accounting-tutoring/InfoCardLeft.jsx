    ...
    return (
        <div className="col-lg-8 d-flex flex-column justify-content-center pe-lg-4 p-4 left-content v100">
            <h1
                ...
                data-scroll-repeat
            >
                Accounting Tutors In Dubai <br /> – IB, IGCSE, A-Levels, & AP
            </h1>
            ...
            >
                Master the art of numbers with Dubai’s top Accounting tutors. Our expert mentors provide detailed guidance and a deep understanding of financial principles, helping you achieve academic excellence.
            </p>
