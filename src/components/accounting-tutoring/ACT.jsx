...
const AchievementsCarousel = () => {
  ...
  const SUBJECTLIST = [
    {
      counts: "01.",
      subjectsName: "Accounting Concepts",
    },
    {
      counts: "02.",
      subjectsName: "Books Of Original Entry",
    },
    {
      counts: "03.",
      subjectsName: "Depreciation",
    },
    {
      counts: "04.",
      subjectsName: "Ledger",
    ...
    {
      counts: "05.",
      subjectsName: "Trial Balance",
    },
    {
      counts: "06.",
      subjectsName: "Financial Statements",
    },
    {
      counts: "07.",
      subjectsName: "Bank Reconciliation Statements",
    },
    {
      counts: "08.",
      subjectsName: "Accounting Ratios",
    },
  ];
  useEffect(() => {
    setMounted(true);
