...
export default function Trainers() {
  ...
  const currentTitle = (
    <>
      The Best British Curriculum <span className="highlight">Trainers</span> For Your<br />Success Journey
    </>
  );
              ...
              {isTrainersSwiper ? (
                <div className="trainersSwiperWrap">
                  ...
                  <button ref={navPrevRef} className="customNavBtn swiper-button-prev">
                    <img src="/images/left-arrow-blue.png" alt="british curriculum tutors in dubai" />
                  </button>
                  <button ref={navNextRef} className="customNavBtn swiper-button-next">
                    <img src="/images/right-arrow-blue.webp" alt="british curriculum tutors in dubai" />
                  </button>
