  ...
  return (
    <div style={{ marginBlock: isMobile ? "10px" : "100px" }}>
      <section className="achievementsSection pb-0" style={{ position: 'relative' }}>
        ...
        <img src="/assets/bgrect25.png" alt="tutors in dubai" className="testimonialRect rect-1" />
        <img src="/assets/bgrect26.png" alt="tutors in dubai" className="testimonialRect rect-2" />
        <img
