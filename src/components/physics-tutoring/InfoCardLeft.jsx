    ...
    return (
        <div className="col-lg-8 d-flex flex-column justify-content-center pe-lg-4 p-4 left-content v100">
            <h1
                ...
                data-scroll-repeat
            >
                Physics Tutors In Dubai <br /> – IB, IGCSE, A-Levels, & AP
            </h1>
            ...
            >
                Achieve your academic goals with Dubai’s top Physics tutors. Our experts provide personalized guidance and a clear understanding of complex concepts, empowering you to excel in your studies.
            </p>
