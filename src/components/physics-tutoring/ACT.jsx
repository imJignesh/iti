...
const AchievementsCarousel = () => {
  ...
  const SUBJECTLIST = [
    ...
    {
      counts: "02.",
      subjectsName: "Kinematics",
    },
    {
      counts: "03.",
      subjectsName: "Energy Transfers",
    },
    {
      counts: "04.",
      subjectsName: "Waves",
    ...
    {
      counts: "05.",
      subjectsName: "Electromagnetism",
    },
    {
      counts: "06.",
      subjectsName: "Electricity",
    },
    {
      counts: "07.",
      subjectsName: "Radioactivity",
    },
    {
      counts: "08.",
      subjectsName: "Atomic & Nuclear",
    },
  ];
  useEffect(() => {
    setMounted(true);
        ...
        <div className="achievementsHeadings mb-5">
          ...
          >
            <h3 className="achievementsTitle text-uppercase">
              ...
              <span className="highlight"> Physics</span> Syllabus{" "}
            </h3>
          </div>
        </div>
