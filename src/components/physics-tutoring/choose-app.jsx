                ...
                <div className="row gy-3">
                  <div className="col-lg-6">
                    <div className="curriculum-info">
                      <Image
                        alt='IB Maths Tutors in Dubai'
                        src="/assets/check-inactive-blue.webp"
                        width={30}
                        height={30}
                        quality={100}
                      />{" "}
                      <h3>IB Physics Tutors (MYP)</h3>
                    </div>
                  </div>
                  <div className="col-lg-6">
                    <div className="curriculum-info">
                  ...
                  <div className="col-lg-6">
                    <div className="curriculum-info">
                      <Image
                        ...
                        quality={100}
                      />{" "}
                      <h3>IGCSE/GCSE Physics Tutors</h3>
                    </div>
                  </div>
                  <div className="col-lg-6">
                    <div className="curriculum-info">
