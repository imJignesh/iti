                  ...
                  <div className="col-lg-6">
                    <div className="curriculum-info">
                      <Image
                        ...
                        quality={100}
                      />{" "}
                      <h1>IGCSE/GCSE Physics Tutors</h1>
                    </div>
                  </div>
                  <div className="col-lg-6">
                    <div className="curriculum-info">
