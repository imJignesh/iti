...
function UpsSection() {
  const uspItems = [
    {
      number: "01",
      icon: <img src="/assets/01.webp" alt="ib myp tutor in dubai" width={205} height={134} />,
      title: "MYP-SPECIFIC TUTORS",
      desc: "Highly qualified IB-specific tutors delivering all-around support.",
    },
    {
      number: "02",
      icon: <img src="/assets/02.webp" alt="ib myp tutor in dubai" width={221} height={134} />,
      title: "INDIVIDUAL ATTENTION",
      desc: "Small group training (SGT) to focus individually on every student.",
    },
    {
      number: "03",
      icon: <img src="/assets/03.webp" alt="ib myp tutor in dubai" width={221} height={134} />,
      title: "GRADE IMPROVEMENT",
      desc: "Better results assurance with rigorous testing and review methods.",
    },
    {
      number: "04",
      icon: <img src="/assets/04.webp" alt="ib myp tutor in dubai" width={226} height={134} />,
      title: "EXAMINATION PREP",
      desc: "Full IB MYP exam prep with tutoring, resources, testing, and review.",
    },
    {
      number: "05",
      icon: <img src="/assets/05.webp" alt="ib myp tutor in dubai" width={222} height={134} />,
      title: "STRONG FOUNDATION",
      desc: "Emphasis on fundamentals for an exceptionally strong foundation.",
    },
    {
      number: "06",
      icon: <img src="/assets/06.webp" alt="ib myp tutor in dubai" width={229} height={134} />,
      title: "STIMULATING ENVIRONMENT",
      desc: "Result-oriented culture ensuring a fun and stimulating environment.",
    },
    {
      number: "07",
      icon: <img src="/assets/07.webp" alt="ib myp tutor in dubai" width={214} height={134} />,
      title: "STRUCTURED LEARNING",
      desc: "Problem-based learning incorporates practical aspects of all units.",
    },
    {
      number: "08",
      icon: <img src="/assets/08.webp" alt="ib myp tutor in dubai" width={221} height={134} />,
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <img src="/assets/arrowright.webp" alt="ib myp tutor in dubai" width={16} height={14} />
              </div>
            </button>
          </a>
        </div>
