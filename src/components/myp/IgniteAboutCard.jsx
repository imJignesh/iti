      ...
      >
        ...
        >
          ...
          <div className="testHeadings">
            ...
            >
              How We Make IB MYP Learning Truly<span className="highlight"> Effective </span>
            </h3>
          </div>
        </div>
      </div>
        ...
        <div className="check-box d-flex flex-md-row flex-column justify-content-around">
          ...
          <div className="d-flex flex-column align-items-center gap-2 mb-4 mb-md-0">
            ...
            <p className="heading-subtitle">
              Expert sessions that simplify                  <br className="d-none d-md-block" />
              concepts & strengthen foundations.
            </p>
          </div>
          ...
          <div className="d-flex flex-column align-items-center gap-2">
            ...
            <p className="heading-subtitle">
              Systematic testing to monitor                 <br className="d-none d-md-block" />
              progress & boost exam readiness.
            </p>
          </div>
        </div>
      </div>
