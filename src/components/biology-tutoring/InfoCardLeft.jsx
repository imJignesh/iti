    ...
    return (
        <div className="col-lg-8 d-flex flex-column justify-content-center pe-lg-4 p-4 left-content v100">
            <h1
                ...
                data-scroll-repeat
            >
                BIOLOGY TUTORS IN DUBAI <br /> – IB, IGCSE, A-LEVELS, & AP
            </h1>
            ...
            >
                Boost your potential in Biology with Dubai’s top tutors. Our expert mentors provide thorough guidance to master complex concepts and achieve top grades in your exams.
            </p>
