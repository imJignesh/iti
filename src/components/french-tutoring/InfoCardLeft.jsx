    ...
    return (
        <div className="col-lg-8 d-flex flex-column justify-content-center pe-lg-4 p-4 left-content v100">
            <h1
                ...
                data-scroll-repeat
            >
                FRENCH TUTORS IN DUBAI <br /> – IB, IGCSE, A-LEVELS, & AP
            </h1>
            ...
            >
                Master French with Dubai’s leading tutors. Our expert mentors provide thorough support to improve your speaking, listening, reading, and writing skills, ensuring you achieve top grades.
            </p>
