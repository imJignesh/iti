    ...
    <section className="ignite-section">
      <div className="ignite-container">
        ...
        <div className="ignite-left">
          ...
          >
            How We Make A-Levels Learning Truly
        ...
        <div className="check-box d-flex flex-md-row flex-column justify-content-around">
          ...
          <div className="d-flex flex-column align-items-center gap-2 mb-4 mb-md-0">
            ...
            <p className="heading-subtitle">
              Engaging expert-led sessions to                    <br className="d-none d-md-block" />
              build a solid academic base.
            </p>
          </div>
          ...
          <div className="d-flex flex-column align-items-center gap-2 mb-4 mb-md-0">
            ...
            <p className="heading-subtitle">
              Extensive learning materials that
          ...
          <div className="d-flex flex-column align-items-center gap-2">
            ...
            <p className="heading-subtitle">
              Ongoing assessments & mocks                   <br className="d-none d-md-block" />
              to fine-tune exam strategies.
            </p>
          </div>
        </div>
      </div>
