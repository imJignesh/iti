      ...
      <div className="fade-in-section"
        ...
        <div className="text-center mb-md-5 mb-4 fade-in-section"
          ...
          <div className="testHeadings">
            ...
            >
              Success Measured By <span className="highlight">Real</span> Academic Impact
            </h3>
          </div>
          {/* Subtitle */}
          <p className="mx-auto fade-in-section subtitle-text"
            ...
            Each achievement at Ignite reflects the dedication <br className="d-none d-md-block" />
            & academic growth of our A-Level students over the years.
          </p>
        </div>
          ...
          <div className="col-md-6 col-6 fade-in-section"
            ...
            <div className="stat-card p-md-4 px-3 py-2 d-flex flex-md-row flex-column align-items-center" style={{
              ...
              >
                ...
                >
                  Extensive A-Level-specific guides
                  <br />
