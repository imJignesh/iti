    ...
    <div className="card mx-auto fade-in-section"
      ...
      {open && (
        <div className="expanded">
          ...
          <p className="subtitle">Cambridge International A-Levels offer three assessment pathways.</p><ul className="subtitle"><li><strong>Pathway one</strong> is AS-only, where the student sits AS papers at the end of Year 12 and stops there with a half-A-Level qualification.</li><li><strong>Pathway two</strong> is staged: AS papers in Year 12, then A2 papers a year later, with AS marks carrying into the final A-Level grade.</li><li><strong>Pathway three</strong> is fully linear, with all papers sat at the end of Year 13. Pearson Edexcel International A-Level (IAL) follows a modular structure with units sat across the two years. Oxford AQA International A-Levels run linear-only.</li></ul><p className="subtitle">The pathway shapes when predicted grades are reliable. A staged Year 12 student has actual AS papers behind them by the time UCAS predictions are due, which makes the predicted grade more defensible. A fully linear student has only school mocks by then. Tutoring intensity and timing should match the pathway, not run on a generic plan.<br /><br />A-Level tuition in Dubai is also where subject-specific exam technique gets built. A-Level Sciences expect synoptic answers in A2 Paper 5 that pull together content across the syllabus. A-Level Economics Paper 4 demands extended-essay-style responses scored against a clear mark band. A-Level Maths splits into Pure (P1-P3 or P1-P4 depending on board) plus Mechanics or Statistics. None of this is intuitive, all of it is coachable.</p>
          <br />
          ...
          <p className="subtitle">The honest answer to "when should we start" depends on which Year the student is in and what the gap looks like.</p><ul className="subtitle"><li><strong>Year 11 students</strong> benefit from starting A-Level coaching in the summer between Year 11 and Year 12 if they are switching from IGCSE/GCSE into A-Levels in a subject they want to take but found hard at IGCSE. The IGCSE-to-A-Level step is bigger than the GCSE-to-A-Level step, particularly in Sciences and Maths. Six to eight weeks of bridging work before September makes Year 12 substantially less stressful.</li><li><strong>Year 12 students</strong> ideally start in September or October, at the beginning of AS. The Year 12 → Year 13 timeline is short enough that gaps left until Year 13 mocks rarely close in time. Students who join in autumn have nine months of structured work before May finals.</li><li><strong>Year 13 students</strong> benefit from starting whenever the gap becomes visible, often after autumn mocks land and predicted grades are submitted. Year 13 work is more compressed and focused on paper technique, command terms, and timed practice. Lifting a predicted B to A in a single Year 13 subject is realistic; lifting two or three across the board is harder once UCAS forms are already in.</li></ul><p className="subtitle">The most common pattern at Ignite is Year 12 students who join our AS-Level tutoring in October to consolidate AS, stay through finals, and continue into Year 13 with the same tutor. Continuity matters because the tutor knows the student's gaps, school's pacing, and the exam board's quirks.</p>
          <br />
