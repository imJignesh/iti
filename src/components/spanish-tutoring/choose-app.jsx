      ...
      <section className="">
        <div className="container">
          ...
          <div className="row gy-5 fade-in-section"
            ...
            data-scroll-class="is-inview"
            data-scroll-repeat>
            <div className="col-lg-6 mx-auto curriculum-content">
              <div
                ...
                <div className="row gy-3">
                  <div className="col-lg-6">
                    <div className="curriculum-info">
                      <Image
                        alt='Spanish Tutors In Dubai'
                        src="/assets/check-inactive-blue.webp"
                        width={30}
                        height={30}
                        quality={100}
                      />{" "}
                      <h3>IB Spanish Tutors ( MYP)</h3>
                    </div>
                  </div>
                  <div className="col-lg-6">
                    <div className="curriculum-info">
                  ...
                  <div className="col-lg-6">
                    <div className="curriculum-info">
                      <Image
                        ...
                        quality={100}
                      />{" "}
                      <h3>IGCSE/GCSE Spanish Tutors</h3>
                    </div>
                  </div>
                  <div className="col-lg-6">
                    <div className="curriculum-info">
