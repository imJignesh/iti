    ...
    return (
        <div className="col-lg-8 d-flex flex-column justify-content-center pe-lg-4 p-4 left-content v100">
            <h1
                ...
                data-scroll-repeat
            >
                Maths Tutors In Dubai <br /> – IB, IGCSE, A-Levels, & AP
            </h1>
            ...
            <h2
                ...
                data-scroll-repeat
            >
                Expert Tutors, Outstanding Results
            </h2>
            ...
            >
                Achieve academic success with Dubai’s top Maths tutors. Our expert mentors provide tailored guidance and a clear understanding of mathematical concepts, helping you excel in your exams.
            </p>
