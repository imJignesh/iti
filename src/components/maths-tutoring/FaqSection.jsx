...
const FAQSection = () => {
  ...
  const faqData = [
    {
      question: "What levels of Maths tutoring does Ignite offer?",
      answer:
        "Ignite provides expert Maths tutoring for IB (AA & AI, SL/HL), IGCSE (Core & Extended), A-Levels (Pure, Mechanics, Stats), and AP Calculus AB/BC and Statistics.",
    },
    {
      question: "Do tutors focus on concept clarity or exam techniques?",
      answer:
        "Both. Sessions are designed to build strong foundational understanding while also teaching students how to approach past paper questions, apply formulas, and manage time effectively.",
    },
    {
      question: "Can Ignite help if I’m struggling with specific Maths topics?",
      answer:
        "Absolutely. Tutors offer targeted support on challenging areas such as calculus, algebra, vectors, or probability through customized lessons and one-on-one doubt solving.",
    },
    {
      question: "Are mock tests & exam-focused practice part of the tutoring?",
      answer:
        "Yes, students regularly attempt past papers, timed mock exams, and receive feedback on their problem-solving accuracy, speed, and presentation.",
    },
    {
      question: "Is there a way to try a class before committing?",
      answer:
        "Yes. Ignite offers a free demo class so students can experience the tutor’s approach and ensure it aligns with their academic goals before enrolling.",
    },
  ];
