                  ...
                  <div className="col-lg-6">
                    <div className="curriculum-info">
                      <Image
                        ...
                        quality={100}
                      />{" "}
                      <h1>IB Psychology Tutors (IBDP)</h1>
                    </div>
                  </div>
                  <div className="col-lg-6">
                    <div className="curriculum-info">
                      <Image
                        ...
                        quality={100}
                      />{" "}
                      <h1>IGCSE/GCSE Psychology Tutors</h1>
                    </div>
                  </div>
                  <div className="col-lg-6">
                    <div className="curriculum-info">
                      <Image
                        ...
                        quality={100}
                      />{" "}
                      <h1>A-Levels Psychology Tutors</h1>
                    </div>
                  </div>
                  {/* <div className="col-lg-6">
                    <div className="curriculum-info">
