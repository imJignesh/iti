    ...
    return (
        <div className="col-lg-8 d-flex flex-column justify-content-center pe-lg-4 p-4 left-content v100">
            <h1
                ...
                data-scroll-repeat
            >
                PSYCHOLOGY TUTORS IN DUBAI <br /> – IB, IGCSE, A-LEVELS, & AP
            </h1>
            ...
            >
                Excel in Psychology with Dubai’s top tutors. Our expert mentors provide clear insights into cognitive, human, and social behaviors, helping you master concepts and achieve top results.
            </p>
