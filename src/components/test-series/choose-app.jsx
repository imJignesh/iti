          ...
          <div className="achievementsHeadings">
            ...
            >
              ...
              >
                ...
                <span className="highlight"> Structured Test Series </span>Before The Finals
              </h3>
            </div>
            <div
              data-scroll
...
.curriculum-section-heading1 {
  ...
  border-image-source: linear-gradient(90deg, #00a49157, #003e3738);
...
.curriculum-section-heading2 {
  ...
  -webkit-text-fill-color: transparent;
    ...
    color: transparent;
  border-bottom: 2px solid;
  border-image-source: linear-gradient(90deg, #3f88ba7a, #16166459);
  border-image-slice: 1;
...
.curriculum-col-right{
  background : linear-gradient(90deg, rgba(164,203,245,0.63) 50%,rgba(231,246,255,0) 98%);
