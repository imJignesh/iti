    ...
    return (
        <div className="col-lg-8 d-flex flex-column justify-content-center pe-lg-4 p-4 left-content v100">
            <h1
                ...
                data-scroll-repeat
            >
                SUBJECT TUTORING IN DUBAI <br /> – IB, IGCSE, A-LEVELS, & AP
            </h1>
            ...
            >
                Achieve academic success with Dubai’s top subject tutors. Our expert mentors provide tailored guidance and a clear understanding of subject concepts, helping you excel in your exams.
            </p>
