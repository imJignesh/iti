  ...
  <a href="/our-team">
    <div data-color={trainer.color} className="trainerCard">
      ...
      <div className="trainerImgWrap">
        ...
        <img src={trainer.img} alt={`Trainer ${trainer.name} ignite training institute`} className="trainerImg" width={300} height={333} />
      </div>
            ...
            {isTrainersSwiper ? (
              ...
              >
                ...
                <button ref={navPrevRef} className="customNavBtn swiper-button-prev">
                  ...
                  <img src="/images/left-arrow-blue.webp" alt="ibdp tutor in dubai" width={32} height={32} />
                </button>
                <button ref={navNextRef} className="customNavBtn swiper-button-next">
                  {/* Placeholder for actual image/icon */}
                  <img src="/images/right-arrow-blue.webp" alt="ibdp tutor in dubai" width={32} height={32} />
                </button>
