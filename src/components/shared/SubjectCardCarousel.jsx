...
export default function SubjectCardCarousel({ config = {} }) {
  const { title = "", subjects = [], altText = "" } = config;
    ...
    <div className={`fade-in-section subjectSection ${isVisible ? 'fade-in' : ''}`} style={{ marginTop: isMobile ? "10px" : "0", marginBottom: isMobile ? "50px" : "0" }}
      ...
      <div className="subjectSectionInner">
        ...
        <div className="subjectRight" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
          ...
          >
            <img src="/assets/up.webp" alt={altText} width={isMobile ? 40 : 50} height={isMobile ? 40 : 50} />
          </button>
          ...
          >
            <img src="/assets/down.webp" alt={altText} width={isMobile ? 40 : 50} height={isMobile ? 40 : 50} />
          </button>
