...
export default function SubjectSupport({ config = {} }) {
  ...
  const { courseTitle = "", accordionItems = [] } = config;
        ...
        >
          ...
          >
            <div className="testHeadings">
              ...
              >
                <h2 className="SubHeading testSubheading">courses</h2>
              </div>
              <h3
                data-scroll
                data-scroll-class="is-inview"
                ...
                style={{ fontSize: "2rem" }}
              >
                Learning Starts Here With <br /><span className="highlight"> {courseTitle} </span> Courses
              </h3>
            </div>
          </div>
      ...
      >
        <div>
          ...
          <div className="text-center mb-4">
            ...
            >
              <div className="SubHeading testSubheading">courses</div>
            </div>
            ...
            >
              Learning Starts Here With <span className="highlight"> {courseTitle} </span> Courses
            </h2>
          </div>
            ...
            {accordionItems.map((item, index) => (
              <div key={index} className="mb-3">
                ...
                <div
                  ...
                  style={{
                    backgroundImage: `linear-gradient(135deg, rgba(227, 242, 253, 0.9), rgba(187, 222, 251, 0.9)), url("/assets/corsebg.webp")`,
                ...
                <div
                  ...
                  style={{
                    ...
                    marginTop: activeIndex === index ? "12px" : "0",
                  }}
                >
                  <div
                    style={{
                  ...
                  >
                    {/* Top Dark Green Section with Image Background */}
                    <div
                      style={{
