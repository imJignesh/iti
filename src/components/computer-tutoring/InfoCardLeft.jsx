    ...
    return (
        <div className="col-lg-8 d-flex flex-column justify-content-center pe-lg-4 p-4 left-content v100">
            <h1
                ...
                data-scroll-repeat
            >
                COMPUTER SCIENCE TUTORS IN DUBAI <br /> – IB, IGCSE, A-LEVELS, & AP
            </h1>
            ...
            >
                Master Computer Science with Dubai’s top tutors. Our expert mentors simplify complex coding concepts and logic, ensuring you excel in your exams and build a strong foundation.
            </p>
