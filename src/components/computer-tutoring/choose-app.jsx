                  ...
                  <div className="col-lg-6">
                    <div className="curriculum-info">
                      <Image
                        ...
                        quality={100}
                      />{" "}
                      <h1>IB Computer Science Tutors (MYP)</h1>
                    </div>
                  </div>
                  <div className="col-lg-6">
                    <div className="curriculum-info">
                      <Image
                        ...
                        quality={100}
                      />{" "}
                      <h1>IB Computer Science Tutors (IBDP)</h1>
                    </div>
                  </div>
                  <div className="col-lg-6">
                    <div className="curriculum-info">
                      <Image
                        ...
                        quality={100}
                      />{" "}
                      <h1>IGCSE/GCSE Computer Science Tutors</h1>
                    </div>
                  </div>
                  <div className="col-lg-6">
                    <div className="curriculum-info">
                      <Image
                        ...
                        quality={100}
                      />{" "}
                      <h1>A-Levels Computer Science Tutors</h1>
                    </div>
                  </div>
                </div>
              </div>
