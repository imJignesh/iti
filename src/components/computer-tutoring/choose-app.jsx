                ...
                <div className="row gy-3">
                  <div className="col-lg-6">
                    <div className="curriculum-info">
                      <Image
                        alt='IB Computer Science Tutors in Dubai'
                        src="/assets/check-inactive-blue.webp"
                        width={30}
                        height={30}
                        quality={100}
                      />{" "}
                      <h3>IB Computer Science Tutors (MYP)</h3>
                    </div>
                  </div>
                  <div className="col-lg-6">
                    <div className="curriculum-info">
                      <Image
                        ...
                        quality={100}
                      />{" "}
                      <h3>IB Computer Science Tutors (IBDP)</h3>
                    </div>
                  </div>
                  <div className="col-lg-6">
                    <div className="curriculum-info">
                      <Image
                        ...
                        quality={100}
                      />{" "}
                      <h3>IGCSE/GCSE Computer Science Tutors</h3>
                    </div>
                  </div>
                  <div className="col-lg-6">
                    <div className="curriculum-info">
                      <Image
                        ...
                        quality={100}
                      />{" "}
                      <h3>A-Levels Computer Science Tutors</h3>
                    </div>
                  </div>
                </div>
              </div>
