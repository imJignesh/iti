...
export default function InfoCardLeft() {
    return (
        <div className="col-lg-8 d-flex flex-column justify-content-center pe-lg-4 p-4 left-content v100">
            ...
            >
                Enhance your language skills with Dubai’s top English tutors. Our expert mentors offer tailored instruction to improve writing, reading, and analysis across multiple curricula.
            </p>
