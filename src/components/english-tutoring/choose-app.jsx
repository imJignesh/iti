                  ...
                  <div className="col-lg-6">
                    <div className="curriculum-info">
                      <Image
                        ...
                        quality={100}
                      />{" "}
                      <h3>IGCSE/GCSE English Tutors</h3>
                    </div>
                  </div>
                  <div className="col-lg-6">
                    <div className="curriculum-info">
