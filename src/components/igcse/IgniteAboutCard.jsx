      ...
      >
        ...
        >
          ...
          <div className="testHeadings">
            ...
            >
              How We Make IGCSE Learning Truly<span className="highlight"> Effective </span>
            </h3>
          </div>
        </div>
      </div>
        ...
        <div className="check-box d-flex flex-md-row flex-column justify-content-around">
          ...
          <div className="d-flex flex-column align-items-center gap-2 mb-4 mb-md-0">
            ...
            <p className="heading-subtitle">
              Dynamic lessons led by expert                     <br className="d-none d-md-block" />
              tutors to reinforce key skills.
            </p>
          </div>
          ...
          <div className="d-flex flex-column align-items-center gap-2">
            ...
            <p className="heading-subtitle">
              Systematic testing to measure                    <br className="d-none d-md-block" />
