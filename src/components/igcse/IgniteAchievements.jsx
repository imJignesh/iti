      ...
      <div className="fade-in-section"
        ...
        <div className="text-center mb-md-5 mb-4 fade-in-section"
          ...
          <div className="testHeadings">
            ...
            >
              Milestones That Clearly <span className="highlight">Reflect</span> Our Impact
            </h3>
          </div>
          {/* Subtitle */}
          <p className="mx-auto fade-in-section subtitle-text"
            ...
            Every achievement at Ignite represents the progress & academic<br className="d-none d-md-block" />
            growth our IGCSE students have attained over the years.
          </p>
        </div>
          ...
          <div className="col-md-6 col-6 fade-in-section"
            ...
            <div className="stat-card p-md-4 px-3 py-2 d-flex flex-md-row flex-column align-items-center" style={{
              ...
              >
                ...
                >
                  Extensive IGCSE-specific guides
                  <br />
        ...
        <div className="text-center fade-in-section"
          ...
          >
            ...
            >
              <img src="/assets/arrowright.webp" alt="igcse tutor in dubai" width={16} height={16} />
            </div>
          </button>
        </div>
      </div>
