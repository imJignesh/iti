...
const FAQSection = () => {
  ...
  const faqData = [
    {
      question: "Which IGCSE subjects does Ignite provide tutoring for?",
      answer:
        "Ignite offers tutoring across a full suite of IGCSE subjects, including Math (Core & Extended), Combined and Triple Sciences, Further Math, English Language & Literature, Business Studies, Economics, Statistics, and Environmental Management (EVM).",
    },
    {
      question: "What exam boards do you support for IGCSE tutoring?",
      answer:
        "Our IGCSE tutoring aligns with Edexcel, Cambridge (CAIE), and Oxford International AQA syllabi, with subject-specific resources and mock exams tailored to each board.",
    },
    {
      question: "Are there one-on-one and group class options available?",
      answer:
        "Yes, Ignite offers both one-on-one bespoke tutoring and small group training (3–6 students), ensuring students receive focused attention or collaborative learning as preferred.",
    },
    {
      question: "How does Ignite support students in their IGCSE exam preparation?",
      answer:
        "We empower students through past paper solving, unit tests, mock exams under exam-like conditions, in-depth paper reviews, and targeted revision sessions.",
    },
    {
      question: "Can I try out the tutoring services before committing to a full course?",
      answer:
        "Yes, Ignite offers a free demo class and study resources, allowing students and parents to evaluate the quality of tutoring and learning environment before enrolling.",
    },
  ];
