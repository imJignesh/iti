    ...
    <div className={`subjectSection ${isVisible ? 'fade-in' : ''}`} style={{ marginTop: isMobile ? "10px" : "0px", marginBottom: isMobile ? "50px" : "0" }}>
      <div className="subjectSectionInner">
        ...
        <div className="subjectRight" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
          ...
          >
            <img src="/assets/up.png" alt="igcse tutor in dubai" width={isMobile ? 40 : 50} height={isMobile ? 40 : 50} />
          </button>
          ...
          >
            <img src="/assets/down.png" alt="igcse tutor in dubai" width={isMobile ? 40 : 50} height={isMobile ? 40 : 50} />
          </button>
