      ...
      <div className="subjectSectionInner">
        ...
        <div className="subjectLeft">
          ...
          <h3 className="subjectTitle">
            Tutoring That Makes Every IGCSE Subject Clear
          </h3>
        </div>
        ...
        <div className="subjectRight" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
          ...
          >
            <img src="/assets/up.webp" alt="igcse tutor in dubai" width={isMobile ? 40 : 50} height={isMobile ? 40 : 50} />
          </button>
          ...
          >
            <img src="/assets/down.webp" alt="igcse tutor in dubai" width={isMobile ? 40 : 50} height={isMobile ? 40 : 50} />
          </button>
