    ...
    <>
      <section className="testimonialSection">
        ...
        <div className="testimonialSliderWrap">
          ...
          >
            <button
              className={`testimonialNavBtn swiper-button-prev`}
              tabIndex={0}
              ...
              <SwiperSlide key={idx}>
                {item.type === "video" ? (
                  ...
                  <div className={`testimonialCard testimonialCardText`}>
                    ...
                    <div className="testimonialTextSubtitle">
                      {item.subtitle}
                    </div>
                  </div>
                )}
            ...
            <button
              className={`testimonialNavBtn swiper-button-next`}
              tabIndex={0}
