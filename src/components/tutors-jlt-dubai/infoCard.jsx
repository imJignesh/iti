...
export default function InfoCard() {
  ...
  const [formData, setFormData] = useState({
    ...
    phone: "",
    grade: "",
    course: "", // 💡 Set default course to empty string to work with the placeholder option
    message: "",
    formType: "Tutor", // Correct formType for submit-form.js
  });
  ...
  const validate = () => {
    ...
    // 3. Phone Validation (Required for this form)
    ...
    // 5. Course Validation (Required)
    // Check if course is empty (which happens if the placeholder is selected)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok && result.success && result.redirectUrl) {
        // Successful submission and redirection path found
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundImage: "url('/assets/tutors.webp')",
          ...
          <div className="row g-0 h-100">
            ...
            >
              ...
              <div
                ...
                style={{
                  borderRadius: "40px",
                  backgroundImage: "url('/assets/tuform.webp')",
                  backgroundSize: "cover",
              ...
              >
                <form onSubmit={handleSubmit}>
                  ...
                  >
                    ...
                    >
                      {/* FIX APPLIED HERE: Added a placeholder option with empty value */}
...
margin-block: 30px !important;
        ...
        @media (max-width: 991.98px) {
          .position-relative.overflow-hidden {
            position: relative;
            background-image: url("/assets/motutors.webp") !important;
