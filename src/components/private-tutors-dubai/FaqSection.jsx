...
const FAQSection = () => {
  ...
  const faqData = [
    {
      question: "What Qualifications Do Your Private Tutors Possess?",
      answer:
        "At Ignite Training Institute, our private tutors are highly qualified professionals with advanced degrees and subject-matter expertise. They bring years of teaching experience and a strong track record of helping students.",
    },
    {
      question: "How Are The One-On-One Tutoring Sessions Conducted?",
      answer:
        "Tutoring is available both in-person and online, allowing students to choose the mode that best suits their schedule and preferences.",
    },
    {
      question: "Can I Customize My Tutoring Schedule Based on My Availability?",
      answer:
        "Yes, Ignite offers flexible scheduling options to accommodate each student’s routine. We work around your availability to ensure consistent and stress-free learning.",
    },
    {
      question: "What Is The Teaching Approach Of Ignite's Individual Tutoring Sessions?",
      answer:
        "We follow a personalized teaching approach tailored to each student’s learning style, with progress tracked through regular assessments and feedback.",
    },
    {
      question: "How Can I Enroll In Tutoring Sessions At Ignite?",
      answer:
        "Getting started is simple. Schedule your free demo class today, and our team will personally reach out to you within the next 24 hours to guide you through the next steps.",
    },
  ];
