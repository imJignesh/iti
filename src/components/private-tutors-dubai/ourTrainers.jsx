...
export default function Trainers() {
  ...
  const desktopTitle = (
    <>
      Individual Learning Backed By <br /><span className="highlight">Experience & Trust</span>
  ...
  const mobileTitle = (
    <>
      Individual Learning Backed <span className="highlight">Experience & Trust</span>
    </>
  );
