export function getUspsData(subject) {
  const configs = {
    "home": {
      heading: "What do you get from Ignite?",
      usps: [
        {
          number: "01",
    ...
    "homeCopy": {
      heading: "Why Choose Ignite for Tutoring in Dubai?",
      usps: [
        {
          number: "01",
          icon: "/images/usp-icon1.webp",
    ...
    "test-series": {
      subheading: "The Extra Edge",
      heading: "What Makes Ignite's Test Series Different?",
      subtitle: "Not Just Tests, Real Preparation",
      description: "Choosing Ignite means partnering with experienced subject-specialist coaches who understand exam patterns, marking standards, and scoring strategies.",
      containerClass: "blue",
      wrapperClass: "uspwrapper",
      ctaText: "KNOW MORE",
      usps: [
        {
          number: "01",
