...
export default async function handler(req, res) {
    ...
    const FORM_CONFIGS = [
        ...
        {
            type: 'Freedemo-copy',
            slugs: ["/join-free-demo-class-copy"],
            zohoUrl: 'https://forms.zohopublic.com/sumitignitetrain1/form/FreedemoCopy/formperma/ryYEivQL7G8wp5ZgriKcktZqwFKODzJPAKlzB35api0/htmlRecords/submit',
            fieldMap: { name: 'SingleLine', email: 'Email', phone: 'PhoneNumber_countrycode', grade: 'SingleLine1', course: 'SingleLine3', message: 'MultiLine', pageinfo: 'SingleLine2' },
            redirectUrl: '/thank-you-organic-copy',
        },
        {
            type: 'A-level-copy',
            slugs: ["/courses/a-level-tutors-in-dubai-copy"],
            zohoUrl: 'https://forms.zohopublic.com/sumitignitetrain1/form/ALevelCopy/formperma/-oVgnUm59ZFRz268bBxvMQdEe7iHAWT4I5YoRzK_aQg/htmlRecords/submit',
            fieldMap: { name: 'SingleLine', email: 'Email', phone: 'PhoneNumber_countrycode', grade: 'SingleLine3', school: 'SingleLine1', message: 'MultiLine', pageinfo: 'SingleLine2' },
            redirectUrl: '/thank-you-organic-copy',
        },
        {
            type: 'IGCSE-Copy',
            slugs: ["/courses/igcse-tutors-in-dubai-copy"],
            zohoUrl: 'https://forms.zohopublic.com/sumitignitetrain1/form/IGCSECopy/formperma/3SqpbKsxRoR10e2qZ1_kajgJh7Jh5gE_9o7kP4QF824/htmlRecords/submit',
            fieldMap: { name: 'SingleLine', email: 'Email', phone: 'PhoneNumber_countrycode', grade: 'SingleLine3', school: 'SingleLine1', message: 'MultiLine', pageinfo: 'SingleLine2' },
            redirectUrl: '/thank-you-organic-copy',
        },
        {
            type: 'MYP-Copy',
            slugs: ["/courses/myp-tutors-in-dubai-copy"],
            zohoUrl: 'https://forms.zohopublic.com/sumitignitetrain1/form/MYPCopy/formperma/HF5D3bTKsJ8QWK5RL0v5qG8bfNKxhM1nZX5Vt1hySaw/htmlRecords/submit',
            fieldMap: { name: 'SingleLine', email: 'Email', phone: 'PhoneNumber_countrycode', grade: 'SingleLine3', school: 'SingleLine1', message: 'MultiLine', pageinfo: 'SingleLine2' },
            redirectUrl: '/thank-you-organic-copy',
        },
        {
            type: 'British_Curriculum-Copy',
            slugs: ["/british-curriculum-tutors-in-dubai-copy"],
            zohoUrl: 'https://forms.zohopublic.com/sumitignitetrain1/form/BritishCurriculumCopy/formperma/AOrul5kCKSRUFH5JWehTMbT0nFzXzZl1hPVNddbdpio/htmlRecords/submit',
            fieldMap: { name: 'SingleLine', email: 'Email', phone: 'PhoneNumber_countrycode', grade: 'SingleLine3', school: 'SingleLine1', message: 'MultiLine', pageinfo: 'SingleLine2' },
            redirectUrl: '/thank-you-organic-copy',
        },
        {
